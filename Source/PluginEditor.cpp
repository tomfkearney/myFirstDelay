...
//==============================================================================
MyFirstDelayAudioProcessorEditor::MyFirstDelayAudioProcessorEditor (MyFirstDelayAudioProcessor& p)
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    mFeedbackSlider.setBounds(110,0,100,100);
    ...
    mDelayTimeSlider.setBounds(220,0,100,100);
...
MyFirstDelayAudioProcessorEditor::~MyFirstDelayAudioProcessorEditor()
{
}

//==============================================================================
void MyFirstDelayAudioProcessorEditor::paint (juce::Graphics& g)
{
...
void MyFirstDelayAudioProcessorEditor::resized()
{
